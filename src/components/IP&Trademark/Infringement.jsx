  ...
  const faqItems = [
    {
      ...
      answer: "Trademark infringement occurs when a registered trademark is used without authorization, leading to confusion or deception among consumers.",
    },
    {
      question: "What are the consequences of trademark infringement?",
      answer: "Penalties include imprisonment (6 months to 3 years), fines (₹50,000 to ₹2,00,000), and additional court-ordered remedies like destruction of infringing goods.",
    },
    {
      question: "How can I avoid trademark infringement?",
      answer: "Conduct thorough research, choose a unique trademark, register it, and use it only with the owner's authorization or for fair purposes.",
    },
    {
      question: "What is the difference between direct and indirect trademark infringement?",
      answer: "Direct infringement involves unauthorized use of a trademark, while indirect infringement includes vicarious or contributory actions that lead to infringement.",
    },
    {
      question: "Can I file a trademark infringement case if my trademark is unregistered?",
      answer: "Yes, you can file an opposition or seek registration before filing a lawsuit.",
    },
    {
      question: "What documents are required to file a trademark infringement case?",
      answer: "You need the trademark advertisement, Legal Proceeding Certificate, registration certificate, and data on financial loss.",
    },
    {
      question: "How long does it take to resolve a trademark infringement case?",
      answer: "The timeline varies depending on the complexity of the case and court proceedings.",
    },
    {
      question: "What should I do before filing a trademark infringement suit?",
      answer: "Send a legal notice to the infringer. If there’s no response, proceed with filing a suit.",
    },
    {
      question: "Can I infringe on a trademark if it’s for a different type of product?",
      answer: "Yes, if the use of a similar mark causes confusion or deception, it can still be considered infringement.",
    },
    {
      question: "Why should I choose LawWheels for filing a trademark infringement case?",
      answer: "LawWheels offers expert legal services, free advice, affordable fees, and a quick, efficient process.",
    },
  ];
        ...
        <div className="container pt-28 xl:!pt-[10rem] lg:!pt-[10rem] md:!pt-[10rem] sm:!pt-[10rem]  relative">
          ...
          <div className="flex flex-col items-center">
            <h3 className="xl:text-[2rem] text-[calc(1.325rem_+_0.9vw)] font-bold !leading-[1.25] tracking-[-0.03em] xl:!px-12 font-space-grotesk text-center">
              Types of Trademarks Infringement
            </h3>
