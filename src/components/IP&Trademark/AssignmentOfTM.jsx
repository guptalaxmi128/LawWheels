  ...
  const faqItems = [
    {
      ...
      answer: "Trademark Assignment is a legal process in which the current owner (Assignor) transfers ownership rights of a trademark to another party (Assignee)."
    },
    {
      question: "What is Trademark Transmission?",
      answer: "Trademark Transmission refers to the transfer of ownership of a trademark due to changes such as mergers or acquisitions, different from assignment which is a voluntary transfer."
    },
    {
      question: "What are the documents required for Trademark Assignment?",
      answer: "Documents typically required include the TM-P form, a written agreement between the parties, and any proof of consideration exchanged."
    },
    {
      question: "What is Trademark Renewal?",
      answer: "Trademark Renewal is the process of extending the registration of a trademark to keep it active, usually required periodically to maintain trademark protection."
    },
    {
      question: "What is a Complete Trademark Assignment?",
      answer: "A Complete Trademark Assignment transfers all rights and interests in the trademark from the Assignor to the Assignee, including exclusive rights for the specified goods or services."
    },
    {
      question: "What is a Partial Trademark Assignment?",
      answer: "A Partial Trademark Assignment transfers only certain rights associated with the trademark, often limited to specific products or services."
    },
    {
      question: "What is Assignment with Goodwill?",
      answer: "Assignment with Goodwill transfers both the trademark and the associated reputation and customer relationships, not just the trademark itself."
    },
    {
      question: "What is Assignment without Goodwill?",
      answer: "Assignment without Goodwill transfers the trademark independently of any associated business or reputation, typically used when the trademark is sold separately from the business."
    },
    {
      question: "How does the Trademark Assignment process work?",
      answer: "The process includes mutual consultation and negotiation, filing the TM-P form, reviewing the application, and receiving acceptance or rejection from the trademark office."
    },
    {
      question: "When should I consult a trademark lawyer?",
      answer: "Consult a trademark lawyer when planning to assign a trademark to ensure that the process is legally sound and to receive guidance on the required documentation and legal obligations."
    }
  ];
