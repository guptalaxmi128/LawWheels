...
const Service2 = () => {
  return (
    <div>
      <section className="wrapper !bg-[#ffffff] mb-20">
        <div
          className="container"
          //  pt-[4.5rem] pb-14 xl:pt-24 lg:pt-24 md:pt-24 xl:pb-[4.5rem] lg:pb-[4.5rem] md:pb-[4.5rem]
        >
          <div className="flex flex-wrap mx-[-15px] xl:mx-[-8px] lg:mx-[-8px] mt-[-10px] lg:!mb-10 xl:!mb-10 items-center">
            <div className="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] mt-[50px] max-w-full">
              {/* <h2 className="!text-[.75rem] uppercase text-[#aab0bc] !mb-3 tracking-[0.02rem] leading-[1.35] font-space-grotesk  text-left sm:text-center"> */}
              <h2 className="!text-[.75rem] uppercase text-[#aab0bc] !mb-3 tracking-[0.02rem] leading-[1.35] font-space-grotesk text-responsive">
                What We Do?
              </h2>
              <h3 className="text-[calc(1.305rem_+_0.66vw)] font-bold xl:text-[1.8rem] !leading-[1.3] mb-5 font-space-grotesk">
                The service we offer is specifically designed to meet your
                needs.
              </h3>
              <p className="font-space-grotesk">
                Our tailored legal expertise is meticulously crafted to address
                your unique challenges, ensuring personalized solutions that
                meet your specific requirements with precision and care.
              </p>
              <a
                href="#"
                className="btn gradient-button text-white !bg-[#343f52] font-space-grotesk border-[#343f52] hover:text-white hover:bg-[#343f52] hover:border-[#343f52] focus:shadow-[rgba(82,92,108,1)] active:text-white active:bg-[#343f52] active:border-[#343f52] disabled:text-white disabled:bg-[#343f52] disabled:border-[#343f52] mt-3 hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,0.15)]"
              >
                More Details
              </a>
            </div>
            <div className="xl:w-7/12 lg:w-7/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] max-w-full xl:!order-2 lg:!order-2 mt-[50px]">
              <div className="flex flex-wrap mx-[-15px] xl:mx-[-12.5px] lg:mx-[-12.5px] md:mx-[-12.5px] mt-[-25px]">
                <div className="xl:w-5/12 lg:w-5/12 md:w-5/12 w-full flex-[0_0_auto] xl:px-[10px] lg:px-[10px] md:px-[12.5px] px-[15px] max-w-full xl:!ml-[8.33333333%] lg:!ml-[8.33333333%] md:!ml-[8.33333333%] !self-end mt-[25px]">
                  <div className="card !bg-[#fef3e4]">
                    <div className="card-body p-[30px]">
                      <div className="svg-inject icon-svg icon-svg-md !w-[2.6rem] !h-[2.6rem] text-[#fab758] text-yellow !mb-3 ">
                        <svg
                      ...
                      <h4 className="font-space-grotesk">24/7 Support</h4>
                      <p className="!mb-0 font-space-grotesk">
                        We’re here for you around the clock, providing
                        assistance whenever you need it most.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] px-[15px] max-w-full !self-end mt-[25px]">
                  <div className="card !bg-[#fae6e7]">
                    <div className="card-body p-[30px]">
                      <div className="svg-inject icon-svg icon-svg-md !w-[2.6rem] !h-[2.6rem] text-[#e2626b] text-red !mb-3 ">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <p className="!mb-0 font-space-grotesk">
                        Your privacy is our top priority; we ensure all your
                ...
                <div className="xl:w-5/12 lg:w-5/12 md:w-5/12 w-full flex-[0_0_auto] xl:px-[10px] lg:px-[10px] md:px-[12.5px] px-[15px] max-w-full mt-[25px]">
                  <div className="card !bg-[#eaf3ef]">
                    <div className="card-body p-[30px]">
                      <div className="svg-inject icon-svg icon-svg-md !w-[2.6rem] !h-[2.6rem] text-[#7cb798] text-leaf !mb-3 ">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <h4 className="font-space-grotesk">Regular Updates</h4>
                      <p className="!mb-0 font-space-grotesk">
                        Stay informed with timely updates on your case’s
                        progress.
                      </p>
                    </div>
                  </div>
                ...
                <div className="xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] px-[15px] max-w-full !self-start mt-[25px]">
                  <div className="card !bg-[#e0e9fa]">
                    <div className="card-body p-[30px]">
                      <div className="svg-inject icon-svg icon-svg-md text-[#3f78e0] text-primary !mb-3 !w-[2.6rem] !h-[2.6rem]">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <p className="!mb-0 font-space-grotesk">
                        We offer efficient legal strategies that deliver results
