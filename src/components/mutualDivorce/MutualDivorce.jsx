...
import { CheckCircle, PhoneCall,X } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="relative z-[1]">
        ...
        <section
          className={`video-wrapper relative overflow-hidden bg-overlay bg-overlay-gradient py-10  xl:min-h-[75vh] custom-height-mutual  !mt-0  xl:rounded-[1rem] lg:rounded-[1rem] md:rounded-[1rem] xl:mx-6 xl:rounded-[1rem] lg:mx-6 lg:rounded-[1rem] md:mx-6 md:rounded-[1rem] mb-24 z-[1]`}
        >
          <video
            poster={movie2}
            src={videoUrl}
          ...
          <div className="video-content absolute z-[2] w-full h-full flex items-center justify-center flex-col left-0 top-0">
            <div className="container pt-[5rem] xl:!pt-[5rem] lg:!pt-[5rem] md:!pt-[5rem]">
              <div className="flex flex-wrap justify-center items-center mx-[-15px] mb-3">
                {/* <div className="lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] max-w-full sm:!mx-auto"> */}
                <img
                  className="logo-dark w-24 h-24 mr-5"
                  src={logoImage}
                  // style={{ marginTop: "5px" }}
                  alt="image"
                ...
                {/* <div className="lg:w-8/12 xl:w-8/12 w-full flex-[0_0_auto] px-[10px] max-w-full !text-center text-white"> */}

                <div>
                  <h1 className="xl:text-[1.6rem] text-[calc(1.395rem_+_1.74vw)] font-semibold  !mb-0 !leading-[1.15] mt-2">
                    <span className="rotator-zoom text-center font-space-grotesk text-white">
                      India's Leading Platform for Legal Assistance
                    </span>
                  </h1>
                  <p className="lead !text-[0.9rem] !leading-[1.6] font-medium xxl:!mx-8 text-center text-white font-space-grotesk mb-0">
     ...
     lg:!mb-0 "
              ...
              <section className="wrapper  w-full flex-[0_0_auto]  max-w-full !mx-auto items-center justify-center">
                <div className="container !pb-[4.5rem] xl:!pb-10 lg:!pb-10 md:!pb-10">
                  <div className="flex flex-wrap xl:mx-[-20px] lg:mx-[-20px] mt-[2px]">
                    <div className="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] xl:px-[5px] lg:px-[20px]  mt-[22px] max-w-full">
                      <div className="feature flex items-center justify-center">
                        <div className="bg-white border border-[#e5f0ed] shadow-md rounded-lg  text-center w-[300px] sm:w-[280px] md:w-[300px] xl:w-[340px]">
                            ...
                            <div className="card card--custom">
                              ...
                              <div className="card__content">
                                <h4 className="card__title font-space-grotesk">
                                  <button>Start Online Process</button>
                                </h4>
                                <p className="font-space-grotesk text-xs text-center subtitle">
                                  Fill out our simple form online to begin your
                                  mutual divorce process easily.
                                </p>
                                <button
                                  className="font-space-grotesk text-xs gradient-button"
                                  onClick={handleMove}
                                >
                        ...
                        <div className="bg-white border border-[#e5f0ed] shadow-md rounded-lg  text-center w-[300px] sm:w-[280px] md:w-[300px] xl:w-[340px]">
                          <div className=" m-1 rounded-lg">
                            <div className="card card--custom">
                              ...
                              <div className="card__content">
                                <h4 className="card__title font-space-grotesk">
                                  <button>Online/ Telephonic Consultant</button>
                                </h4>
                                <p className="font-space-grotesk text-xs text-center subtitle">
                                  Book a consultation to get expert legal
                          ...
                          <div className=" m-1 rounded-lg">
                            <div className="card card--custom">
                              ...
                              <div className="card__content">
                                ...
                                <p className="font-space-grotesk text-xs text-center subtitle">
                                  Connect with us on call or WhatsApp for quick
                                  answers and instant support.
                                  {/* for your divorce queries. */}
                                </p>
                                <button className="font-space-grotesk text-xs gradient-button"  onClick={() => setShowChat(!showChat)}>
        ...
        <div className="modal-container">
          <div className="modal-content">
            <div className="p-5 text-center">
              ...
              <div className="mt-4 text-base font-space-grotesk mb-2">Connect with us on WhatsApp</div> 
              <button
                data-tw-merge=""
                type="button"
                className="transition font-space-grotesk gradient-button flex duration-200 border shadow-sm inline-flex items-center justify-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&:hover:not(:disabled)]:bg-opacity-90 [&:hover:not(:disabled)]:border-opacity-90 [&:not(button)]:text-center disabled:opacity-70 disabled:cursor-not-allowed bg-primary border-primary text-white dark:border-primary"
                
              >
                <FaWhatsapp className="w-4 h-4 text-white mr-1" /> +91 9899924222
              </button>
              <div className="mt-4 text-base font-space-grotesk mb-2">Contact us via toll-free number</div> 
              <button
                data-tw-merge=""
                type="button"
                className="transition font-space-grotesk gradient-button flex duration-200 border shadow-sm inline-flex items-center justify-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&:hover:not(:disabled)]:bg-opacity-90 [&:hover:not(:disabled)]:border-opacity-90 [&:not(button)]:text-center disabled:opacity-70 disabled:cursor-not-allowed bg-primary border-primary text-white dark:border-primary"
              ...
              >
                <PhoneCall className="w-4 h-4 text-white mr-1" /> 1800 571 1413
              </button>
        ...
        <div className="modal-container">
          <div className="modal-content">
            <div className="p-5 text-center">
              ...
              />
              <div className="mt-4 text-base font-space-grotesk">
                Thank you for getting in touch with us! One of our experts will
                connect with you shortly to assist you further.
              </div>
            </div>
