        ...
        <div className="container pb-12 pt-10">
          <div className="flex flex-wrap mx-[-15px]">
            ...
            <h2 className="text-[calc(1.305rem_+_0.66vw)] font-bold xl:text-[1.5rem] leading-[1.3] mb-3 text-left font-space-grotesk">
              ...
              Law Wheels is committed to ensuring the security and confidentiality of your personal data.
              </p>
            </div>
            <div className="w-full px-[15px]">
            <h2 className="text-[calc(1.305rem_+_0.66vw)] font-bold xl:text-[1.5rem] leading-[1.3] mb-3 text-left font-space-grotesk">
              ...
              <p className="lead leading-[1.65] text-[0.9rem] font-medium text-left mb-5 font-space-grotesk">
              We collect personal data necessary for providing our mutual divorce services, including names, contact details, and divorce-related information.
              </p>
            </div>
            ...
            <h2 className="text-[calc(1.305rem_+_0.66vw)] font-bold xl:text-[1.5rem] leading-[1.3] mb-3 text-left font-space-grotesk">
              ...
              <p className="lead leading-[1.65] text-[0.9rem] font-medium text-left mb-5 font-space-grotesk">
              You have the right to access, correct, or delete your personal data. Contact us at connect@lawwheels.com to exercise these rights.
              </p>
            </div>
          </div>
        </div>
