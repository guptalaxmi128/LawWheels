...
const FAQ = () => {
  ...
  return (
    <div className="lg:pt-20 xl:pt-20 sm:pt-0 xxl:pt-40">
                  ...
                  <div id="accordion-1" className="accordion-wrapper">
                      ...
                      >
                        <div className="card-body flex-[1_1_auto]  p-[0_1.25rem_.25rem_2.35rem]">
                          <p className="font-space-grotesk">
                            A mutual divorce is when both spouses agree to end
                            their marriage amicably and jointly file for
                            divorce. It involves a cooperative approach to reach
                            a settlement.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="card accordion-item mb-5 !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                      ...
                      >
                        <div className="card-body flex-[1_1_auto]  p-[0_1.25rem_.25rem_2.35rem]">
                          <p className="font-space-grotesk">
                            The mutual divorce process typically takes around 6
                            to 18 months, depending on the specific
                    ...
                    <div className="card accordion-item mb-5 !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                      ...
                      >
                        ...
                        >
                          What are the benefits of opting for a mutual divorce?
                        </button>
                        <FontAwesomeIcon
                          icon={
                      ...
                      >
                        <div className="card-body flex-[1_1_auto]  p-[0_1.25rem_.25rem_2.35rem]">
                          <p className="font-space-grotesk">
                            Mutual divorce is generally faster, less expensive,
                            and less emotionally taxing than contested divorce.
                            It allows for a more amicable settlement and reduces
                            conflicts.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="card accordion-item mb-5 !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                      ...
                      >
                        ...
                        >
                          Do both parties need to be present for filing the
                      ...
                      >
                        <div className="card-body flex-[1_1_auto]  p-[0_1.25rem_.25rem_2.35rem]">
                          <p className="font-space-grotesk">
                            Yes, both parties must be present to sign the joint
                            petition for mutual divorce and attend the court
                            hearings.
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        <div className="card-body flex-[1_1_auto]  p-[0_1.25rem_.25rem_2.35rem]">
                          <p className="font-space-grotesk">
                            ...
                            proof of living separately, joint petition, and
                            statements of income, assets, and child custody
